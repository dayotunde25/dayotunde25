...
<head>
	...
	<title>Project Jobs - Applicants for the job <?php echo "$job_title"; ?></title>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<h5 class="footer-title">About Project Jobs</h5>
											<p>Project Jobs is a Job Search Engine, online job search Engine developed by N/CS/20/2904 for his project in 2022.</p>

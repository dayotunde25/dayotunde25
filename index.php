...
<script type="text/javascript" src="js/unpkg/axios.min.js"></script>
<script>
...
function getJobs(){
	console.log("Get job start")
	let url = "https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=nigeria&location=Nigeria&trk=public_jobs_jobs-search-bar_search-submit&currentJobId=2931031787&position=1&pageNum=0&start=0";
	axios(url).then(function(job){
		$.ajax({
			url:"http://localhost/CODE/PROJECTCODE/System/MyScraper/linkedinJSapi.php",
			method:'post',
			data:{'data':job.data},
			crossDomain:true,
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php">Job Providers</a>
							</li>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">Register as Job Provider</a>
						</div>
						<div class="col-sm-6 col-md-6">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>Lets help you get the right job opportunity</h1>
					<p>Finding your next job or career on Project Jobs</p>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Project Jobs is a job search portal, online job management system developed by Fatoye Babatunde for his project in November 2022.</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Moscool Softwares</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Fatoye Babatunde N/CS/20/2904</a></li>
								</ul>
